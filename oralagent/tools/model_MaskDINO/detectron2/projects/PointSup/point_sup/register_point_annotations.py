...
_PREDEFINED_SPLITS_COCO["coco"] = {
    ...
    "coco_2017_train_points_n10_v1_without_masks": ("dental_plague_dataset/train/JPEGImages/", "dental_plague_dataset/train/train_ins_ToI_n10_v1_without_masks.json"),
}
